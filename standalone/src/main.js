...
async function action(name, id) {
  ...
  const labels = {
    ...
    revoke_installation:
      "บล็อกเฉพาะการติดตั้งนี้และยกเลิกเซสชันปัจจุบันของการติดตั้งนี้หรือไม่ หากต้องการบล็อกทุกเครื่อง ให้ระงับบัญชีแทน การระงับบัญชีจะยกเลิกทุก installation และ Launcher session ปัจจุบัน",
